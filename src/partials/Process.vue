    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-10 pb-12 md:pt-16 md:pb-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 mb-4" data-aos="fade-up">Core Course Pillars</h2>
          <p
            class="text-xl text-gray-400"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            Enhance your Vue.js skills by delving into the essential aspects of
        ...
        >
          ...
          <div class="relative flex flex-col items-center" data-aos="fade-up">
            ...
            <h4 class="h4 mb-2">
              <span class="text-gray-400">1</span>. Planning
            </h4>
            <p class="text-lg text-gray-400 text-center">
              Define requirements and visualize.
            </p>
          </div>
          ...
          >
            ...
            <h4 class="h4 mb-2">
              <span class="text-gray-400">2</span>. Design
            </h4>
            <p class="text-lg text-gray-400 text-center">
              Dive into design system's worlds
            </p>
          </div>
          ...
          >
            ...
            <h4 class="h4 mb-2">
              <span class="text-gray-400">3</span>. Development
            </h4>
            <p class="text-lg text-gray-400 text-center">
              Develop complex Vue.js component
            </p>
          </div>
        </div>
      </div>
